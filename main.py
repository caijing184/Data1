...
class BreastCancerKaggleAnalyzer:
    ...
    def run_full_analysis(self):
        ...
        try:
            ...
            print("EDA分析完成")
            top_corr = self.results['eda']['correlation']['top_features_with_target'][:3]
            print(f"与目标最相关的特征: {top_corr[0]['feature2'] if top_corr[0]['feature1'] == 'target' else top_corr[0]['feature1']}")
